...
export type BulletinPaseoNextV2DispatchError = Anonymize<Iam4td08afnm42>;
type IAsset = PlainDescriptor<void>;
export type BulletinPaseoNextV2Extensions = {};
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type BulletinPaseoNextV2 = {
    descriptors: {
    ...
    asset: IAsset;
    extensions: BulletinPaseoNextV2Extensions;
    getMetadata: () => Promise<Uint8Array>;
    genesis: string | undefined;
};
declare const _allDescriptors: BulletinPaseoNextV2;
export default _allDescriptors;
export type BulletinPaseoNextV2Apis = ApisFromDef<IRuntimeCalls>;
export type BulletinPaseoNextV2Queries = QueryFromPalletsDef<PalletsTypedef>;
export type BulletinPaseoNextV2Calls = TxFromPalletsDef<PalletsTypedef>;
export type BulletinPaseoNextV2Events = EventsFromPalletsDef<PalletsTypedef>;
export type BulletinPaseoNextV2Errors = ErrorsFromPalletsDef<PalletsTypedef>;
export type BulletinPaseoNextV2Constants = ConstFromPalletsDef<PalletsTypedef>;
export type BulletinPaseoNextV2ViewFns = ViewFnsFromPalletsDef<PalletsTypedef>;
export type BulletinPaseoNextV2CallData = Anonymize<I88472ck6vehhv> & {
    value: {
        type: string;
    };
};
