import { default as paseoPeopleNext, type PaseoPeopleNextWhitelistEntry } from "./paseoPeopleNext";
export { paseoPeopleNext };
export type * from "./paseoPeopleNext";
import { default as bulletinPaseoNextV2, type BulletinPaseoNextV2WhitelistEntry } from "./bulletinPaseoNextV2";
export { bulletinPaseoNextV2 };
export type * from "./bulletinPaseoNextV2";
...
export type WhitelistEntry = PaseoPeopleNextWhitelistEntry | BulletinPaseoNextV2WhitelistEntry;
export type WhitelistEntriesByChain = Partial<{
    "*": WhitelistEntry[];
    paseoPeopleNext: WhitelistEntry[];
    bulletinPaseoNextV2: WhitelistEntry[];
}>;
